...
public class HeroBattleActionAtkDefeat : HeroBattleAction
{
    ...
    {
        // 튕겨내지는 모션
        yield return AnimationDeley(0.2f, Actor.AniType.ANI_BREAK);
        yield return MoveBackward(0.5f, Define.MOVE_BACK_BREAK_SPEED_X, Actor.AniType.ANI_BREAK);

        // 처맞는 모션
        yield return MoveBackward(0.1f, Define.MOVE_BACK_DEFEAT_SPEED_X, Actor.AniType.ANI_DEFEAT);
